...
import { getEmployees, deleteEmployee, createEmployeeUser, updateUserEmployee } from "../services/EmployeeServices";
...
function Professional() {
  ...
  const fetchData = async () => {
    try {
      ...
      const mappedRows: Row[] = employeesData.map((employee: Employee) => {
        ...
        await Promise.all(
          selectedUserIds.map(async (userId) => {
            try {
              ...
              const employee = employeeResponse.find((f: Employee) => f.userId === userId);
